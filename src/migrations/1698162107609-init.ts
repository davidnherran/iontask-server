...
export class Init1698162107609 implements MigrationInterface {
    name = 'Init1698162107609'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('ADMINISTRATOR', 'EXECUTANT')`);
